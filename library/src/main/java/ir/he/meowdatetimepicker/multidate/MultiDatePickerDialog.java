...
package ir.he.meowdatetimepicker.multidate;
...
import ir.he.meowdatetimepicker.date.AccessibleDateAnimator;
...
public class MultiDatePickerDialog extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSelectedMonthTextView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mSelectedDayTextView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mYearView.setTypeface(MeowTypefaceHelper.getRegularFont());
        ...
        okButton.setTypeface(MeowTypefaceHelper.getMediumFont());
        ...
        cancelButton.setTypeface(MeowTypefaceHelper.getMediumFont());
