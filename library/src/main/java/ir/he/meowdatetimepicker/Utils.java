...
import ir.he.meowdatetimepicker.utils.PersianCalendarUtils;
...
public class Utils {
    ...
    public static int getPaddingFont(Context context) {
        return dpToPx(MeowTypefaceHelper.getFontPadding(), context.getResources());
    }
}
