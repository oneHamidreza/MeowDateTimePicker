...
package ir.he.meowdatetimepicker.time;
...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mHourView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mHourSpaceView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mMinuteSpaceView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mMinuteView.setTypeface(MeowTypefaceHelper.getRegularFont());
        mAmPmTextView.setTypeface(MeowTypefaceHelper.getRegularFont());
        ...
        mOkButton.setTypeface(MeowTypefaceHelper.getMediumFont());
        ...
        mCancelButton.setTypeface(MeowTypefaceHelper.getMediumFont());
        ...
        if (mIs24HourMode) {
            ...
            separatorView.setTypeface(MeowTypefaceHelper.getRegularFont());
