...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        mTypefaceLight = MeowTypefaceHelper.getLightFont();
        mTypefaceRegular = MeowTypefaceHelper.getRegularFont();
        ...
        mSelectedPaint.setTypeface(MeowTypefaceHelper.getBoldFont());
    ...
    private void calculateGridSizes(float numbersRadius, float xCenter, float yCenter,
        ...
        yCenter += Utils.getPaddingFont(getContext());
